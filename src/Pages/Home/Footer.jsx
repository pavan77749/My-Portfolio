...
function Footer() {
  return (
    <footer className="footer--container">
      ...
      <div style={{color:"#000", fontWeight:700,fontSize:'32px', fontFamily:'sans-serif'}}>
        <span style={{color:'#ff205f', fontSize:"35px", fontWeight:900}}>{"</>"}</span> PG Dev
      </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li id="facebook-icon">
              <a
                href="https://www.facebook.com/profile.php?id=100077343240195&sfnsn=wiwspwa&mibextid=RUbZ1f"
            ...
            <li>
              <a
                href="https://www.instagram.com/pavan_s_gupta_2004?utm_source=qr&igsh=MWtob3FsN3c2aTNsbA=="
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href=" https://x.com/PavanGupta68632?t=4ZC4n1XhI0BXZgFByIGaGw&s=08"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/pavan-gupta-956bb4265?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
